...
@section('content')
    ...
    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12"
        ...
        {!! Form::open(['url' => '/artisan', 'files' => true, 'class'=>'form_effect']) !!}
        ...
        <div class="form-group {!! $errors->has('email') ? 'has-error' : '' !!}">
            {!! Form::text('email', null, ['class' => 'form-control', 'placeholder' => 'Artisan\'s email address', 'value' => old('email'), 'required']) !!}
        ...
        {!! Form::submit('Create artisan', ['class' => 'btn btn-info pull-right']) !!}
        {!! Form::close() !!}
