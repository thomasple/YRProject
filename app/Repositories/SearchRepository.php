...
class SearchRepository
{
    ...
    public function index()
    {
        ...
        {
            if($this->check($artisan_service)AND !(in_array(Artisan::find($artisan_service->artisan_id),$results)))
            {
                $res=Artisan::find($artisan_service->artisan_id);
